...
expected_variables <- c("d_f", "all_items", "organization_name", "present_metrics", "present_subset_groups",
                        ...
                        "q_group_info", "COHORT_LABEL", "LONG_COHORT_LABEL", "DATA_PULL_DATE_READABLE")
...
participation_summary_df <- data.frame(
  variable = c("n", "expected_n"),
  session_1 = c(rss$n_100_1, rss$expected_participants),
  session_2 = c(rss$n_100_2, rss$expected_participants),
  both = rss$n_both_100
)
...
The table below shows how many students at `r organization_name` participated in each session of the program during the  `r COHORT_LABEL` school year as of `r DATA_PULL_DATE_READABLE`. 
...
Do you have tips on what did or didn’t work for implementing the program at your school? We’d love to hear from you!  Please send an email to support@perts.net if you’d like to share more about your school’s experience with the program. If you want to learn about other continuous improvement programs at PERTS please visit our Engagement Project [page](https://www.perts.net/engage?utm_source=hg18spring&utm_medium=report&utm_campaign=redirect).
...
PERTS is an organization that empowers educators to improve student outcomes by applying research-based practices. Students from underserved communities graduate from high school and college at far lower rates than their advantaged peers, and these opportunity gaps powerfully perpetuate longstanding socioeconomic inequalities. Despite notable pockets of excellence and equity, our education system chronically fails to scale up effective strategies to reach the students who need them most.

PERTS (Project for Education Research that Scales) helps educators apply evidence-based strategies in order to advance educational excellence and equity on a large scale. We believe that properly scaling educational research can empower schools to reduce inequality and create better experiences and outcomes for students and teachers alike. Learn more at [www.perts.net](https://www.perts.net).